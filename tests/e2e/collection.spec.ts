...
test('COLLECTION: summer-first exchange directly unlocks one character, not original form',async({page},info)=>{
  ...
  await expect(page.locator('.roster-tile[data-id="C07"]')).toContainText('待命');
  await page.locator('.roster-tile[data-id="C07"]').click();
  await page.locator('[data-action="roster-wardrobe"]').click();
  await page.locator('[data-action="roster-preview"][data-id="C07-original"]').click();
  await expect(page.locator('[data-action="roster-equip"]')).toBeDisabled();
  await page.locator('[data-action="roster-preview"][data-id="C07-summer"]').click();
  ...
  await page.locator('[data-roster-view="character"] [data-action="toggle-character"][data-id="C01"]').click();
  await page.locator('[data-action="roster-close"]').click();
  await page.locator('.roster-tile[data-id="C07"]').click();
  await page.locator('[data-roster-view="character"] [data-action="toggle-character"][data-id="C07"]').click();
  await page.locator('[data-action="captain"][data-id="C07"]').click();
  await page.locator('[data-action="roster-close"]').click();
